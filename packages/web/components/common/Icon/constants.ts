...
export const iconPaths = {
  ...
  'core/dataset/indexEnhance': () => import('./icons/core/dataset/questionExtension.svg'),
  ...
  astronomy: () => import('./icons/scienceOne/astronomy.svg'),
  biology: () => import('./icons/scienceOne/biology.svg'),
  chemical: () => import('./icons/scienceOne/chemical.svg'),
  common: () => import('./icons/scienceOne/common.svg'),
  earth: () => import('./icons/scienceOne/earth.svg'),
  engineering: () => import('./icons/scienceOne/engineering.svg'),
  environment: () => import('./icons/scienceOne/environment.svg'),
  material: () => import('./icons/scienceOne/material.svg'),
  math: () => import('./icons/scienceOne/math.svg'),
  medicine: () => import('./icons/scienceOne/medicine.svg'),
  physics: () => import('./icons/scienceOne/physics.svg'),
