...
// 本地注册 API
export const postLocalRegister = ({ username, password }: { username: string; password: string }) =>
...
export const getAllUsers = (params?: {
  ...
  GET<{
    ...
    limit: number;
    totalPages: number;
  }>('/support/user/getAllUsers', params);

export const switchUser = (targetUserId: string) =>
  POST<{
    user: any;
    token: string;
  }>('/support/user/switchUser', { targetUserId });
