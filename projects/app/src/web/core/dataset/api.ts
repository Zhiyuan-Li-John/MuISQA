...
import type {
  EnhanceIndexProps,
  EnhanceIndexResponse
} from '@/pages/api/core/dataset/data/enhanceIndex';
import type {
  EnhanceCollectionIndexProps,
  EnhanceCollectionIndexResponse
} from '@/pages/api/core/dataset/collection/enhanceIndex';
...
/* ================== index enhance ======================== */
export const postEnhanceDatasetIndex = (data: EnhanceIndexProps) =>
  POST<EnhanceIndexResponse>('/core/dataset/data/enhanceIndex', data);

export const postEnhanceCollectionIndex = (data: EnhanceCollectionIndexProps) =>
  POST<EnhanceCollectionIndexResponse>('/core/dataset/collection/enhanceIndex', data);
