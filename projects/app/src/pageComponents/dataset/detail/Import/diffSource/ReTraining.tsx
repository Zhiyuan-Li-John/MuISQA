  ...
  const { loading } = useRequest2(() => getDatasetCollectionById(collectionId), {
    ...
    onSuccess: (collection) => {
      ...
      processParamsForm.reset({
        ...
        autoIndexesModel: collection.autoIndexesModel ?? defaultFormData.autoIndexesModel,
        autoIndexesSize: collection.autoIndexesSize ?? defaultFormData.autoIndexesSize,
