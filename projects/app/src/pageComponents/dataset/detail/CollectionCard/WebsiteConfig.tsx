...
const WebsiteConfigModal = ({
  ...
  const form = useForm<CollectionChunkFormType>({
    defaultValues: {
      ...
      autoIndexesModel: chunkSettings?.autoIndexesModel || defaultFormData.autoIndexesModel,
      autoIndexesSize: chunkSettings?.autoIndexesSize || defaultFormData.autoIndexesSize,
